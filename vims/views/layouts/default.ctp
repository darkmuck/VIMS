		  ...
		  <td width="860px">
			<table class="tblGeneral">
						  ...
						  <div class="nav">
							  <?php 
								echo 
									...
									$html->link($html->image("buttons/button_computers.png", array('title' => 'Computers', 'border' => 0)), "/computers/", array('escape'=>false)) .
									$html->image("buttons/button_spacer_10px.png") . 

									$html->link($html->image("buttons/button_users.png", array('title' => 'Users', 'border' => 0)), "/users/", array('escape'=>false)) .
									$html->image("buttons/button_spacer_10px.png") . 

									$html->link($html->image("buttons/button_admins.png", array('title' => 'Admins', 'border' => 0)), "/admins/", array('escape'=>false)) .
									$html->image("buttons/button_spacer_10px.png") . 

									$html->link($html->image("buttons/button_reports.png", array('title' => 'Reports', 'border' => 0)), "/incidents/reports/", array('escape'=>false)) .
									$html->image("buttons/button_spacer_10px.png")
			  ...
			  <tr>
				...
				<?php
				  echo $html->link($html->image("icons/help.png", array('title' => 'Help', 'border' => 0)), "/files/admin_guide.pdf", array('escape'=>false));
				  echo $html->link($html->image("icons/printer.png", array('title' => 'Print', 'border' => 0)), "javascript:window.print()", array('escape'=>false));
				  echo $html->link($html->image("icons/door_in.png", array('title' => 'Logout', 'border' => 0)), "/users/logout", array('escape'=>false));
				  ?>
