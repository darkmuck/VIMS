...
////////////////
	...
	/////
		...
		$paginator->options(array('update' => 'mainContent', 'indicator' => 'ajaxLoaderGeneral', 'url'=>array('controller'=>'Incidents', 'action'=>'index')));
		...
		if (!empty($errorMessage)) {
			echo '<br /> <center>'. $html->image('icons/exclamation2.png', array('style'=>'vertical-align: middle')) .' <strong>'. $errorMessage . '</strong> </center> ';
				...
				echo'	</td>
						...
						<font size="-2">
						<b> View: </b>
						<b>'. $html->link('Pending & Your Incidents', '/incidents/index') .'</b> | '
	...
	echo	'</div>'
		...
		$paginator->options(array('update' => 'mainContent', 'indicator' => 'ajaxLoaderGeneral', 'url'=>array('controller'=>'Incidents', 'action'=>'index')));
				...
				echo'	</td>
						...
						<font size="-2">
						<b> View: </b>
						<b>'. $html->link('Your Open Incidents', '/incidents/index') .'</b> | '
