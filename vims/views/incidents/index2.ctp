...
/**********
View Name: index2
Description: This view is the index2 view where the user or administrator will see for the incidents component, it shows a listing of the incidents from the database.
...
$breadCrumbUrl = '/incidents/index2';
...
////////////////
	...
	/////
		...
		$paginator->options(array('update' => 'mainContent', 'indicator' => 'ajaxLoaderGeneral', 'url'=>array('controller'=>'Incidents', 'action'=>'index2')));
		...
		if (!empty($errorMessage)) {
			echo '<br /> <center>'. $html->image('icons/exclamation2.png', array('style'=>'vertical-align: middle')) .' <strong>'. $errorMessage . '</strong> </center> ';
				...
				echo'	</td>
						...
						<b>'.  $html->link('All Assigned Incidents', '/incidents/index2') . '</b> | '
	...
	echo'<div class="divContentCenter">
			<b>You do not have access to this area.</b>
		 </div>';
	}//end if
